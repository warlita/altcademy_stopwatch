// this includes the constructor method. It will initiate the component state with a property: timePassInMilliSeconds
class StopWatch extends React.Component {
 ...
 //we have a h2 element that will display the time in seconds. however, since we are storing the time in the component state as milliseconds that we have to divide the value by 1000 convert it into seconds. 
  render() {
    return (
      <div>
